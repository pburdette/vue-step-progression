  ...
  watch: {
    currentStep: function currentStep(currentStep$1, prevStep) {
      ...
      if ((prevStep + 1) === 2) {
          ...
          console.log(currentStep$1, prevStep);
      } else {
